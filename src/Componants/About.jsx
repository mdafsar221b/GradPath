  ...
  return (
    <div className="flex items-center justify-center flex-col">
      ...
      <div>
       ...
       <div className="mt-6">
      <a className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out gap-2" href="/src\assets\Resources\Syllabus.pdf" download>
      Download Syllabus    
