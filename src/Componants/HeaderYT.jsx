...
const HeaderYT = () => {
  return (
    ...
    <div className="flex gap-3 mx-4  sm:mx-6 lg:mx-8 text-gray-100">
    ...
    <div className="mt-6 text-lg text-gray-300 leading-relaxed text-center mb-6 font-Flux px-6 sm:px-15 lg:px-17" >
